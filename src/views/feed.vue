        ...
        <div v-masonry transition-duration="0.1s" item-selector=".item">
            <div
                ...
                <div class="card" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><a :href="item.url" target="_blank" @click="trackArticleOpenEvent(item)">{{ item.title }}</a></h5>
...
export default {
    ...
    methods: {
        ...
        trackArticleOpenEvent (item) {
            this.$ga.event('Article', 'Open', `${item.title} - ${item.url}`);
        }
    }
};
</script>
